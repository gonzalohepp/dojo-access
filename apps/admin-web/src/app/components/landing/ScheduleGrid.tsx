...
const schedules: Record<"acondicionamiento" | "martiales", Schedule> = {
  ...
  martiales: {
    ...
    clases: [
      ...
      { nombre: 'MMA', horario: '19:00 A 20:30', tipo: 'mma', col: 1, row: 5 },
      { nombre: 'GRAPPLING', horario: '20:30 A 22:00', tipo: 'grappling', col: 2, row: 5 },
      { nombre: 'MMA', horario: '19:00 A 20:30', tipo: 'mma', col: 3, row: 5 },
      { nombre: 'GRAPPLING', horario: '20:30 A 22:00', tipo: 'grappling', col: 4, row: 5 },
      { nombre: 'MMA', horario: '19:00 A 20:30', tipo: 'mma', col: 5, row: 5 },
      { nombre: 'BJJ', horario: '20:30 A 22:00', tipo: 'bjj', col: 1, row: 6 },
      { nombre: 'JUDO', horario: '19:00 A 20:30', tipo: 'judo', col: 2, row: 6 },
      { nombre: 'BJJ', horario: '20:30 A 22:00', tipo: 'bjj', col: 3, row: 6 },
      { nombre: 'JUDO', horario: '19:00 A 20:30', tipo: 'judo', col: 4, row: 6 },
      { nombre: 'BJJ', horario: '20:30 A 22:00', tipo: 'bjj', col: 5, row: 6 },
    ],
  },
}
